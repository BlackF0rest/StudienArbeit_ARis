...
Bei dem Entwurf einer \ac{DIY}-\ac{AR}-Brille bestehen verschiedene Herausforderungen und Zielkonflikte. Zusammenfassen lassen sich diese in konkreten Trade-Offs:
...
Ziel ist die Konstruktion eines Optikkonzepts, welche zusammen mit der Elektronik und Mechanik eine vollintegrierte \ac{AR}-Brille bildet. Dabei soll die Optik in das Gesamtsystem integriert und eine Softwarelösung zur Ansteuerung des Displays und der Sensorik entwickelt werden. Die Software soll verschiedene Funktionalitäten wie die Grundlegende Anzeige von Daten sowie die Einbindung von Sensorendaten und Interaktionsmöglichkeiten bieten.

\section{Methodisches Vorgehen}
Konkret soll somit zuerst ein technisch vollständiges Konzept zur optischen und softwaretechnischen Realisierung einer \ac{AR}-Brille ausgearbeitet werden. Dieses basiert auf einer vollumfänglichen Anforderungsanalyse (\ref{apx:anforderungen}) und umfangreichen technischen Recherchen zu Optiken und Softwarelösungen.

Anschließend soll ein Systemdesign umgesetzt werden, welches die verschiedenen gefundenen Anforderungen und Aspekte in Einklang bringt. Dabei werden verschiedene technische Lösungen hinsichtlich ihrer Umsetzbarkeit, Kosten und Performance bewertet und miteinander verglichen.

Des Weiteren werden verschiedene Prototypen zur Validierung einzelner Komponenten und Teilsysteme entwickelt und getestet. Hierbei liegt der Fokus auf der Integration der Optik in das Gesamtsystem sowie der Ansteuerung des Displays und dem Zusammenspiel der verschiedenen Softwareteile mittels geeigneter Softwarelösungen.

Zuletzt wird die Validierung des Konzepts anhand zu  Beginn definierter Kriterien durchgeführt.

\section{Kooperativer Charakter des Projekts}
Das Projekt wird in zwei Arbeitsbereiche aufgeteilt. Dabei wird die Elektronik und Mechanik (elektrisches Design, Energieversorgung, Wärmemanagement, Gehäusekonstruktion) von Nura Fasano verantwortet sowie die Optik und Software (Optik-Integration, Display-Ansteuerung, Funktionalitäten) von Bastian Kiefer.
